...
## 🔄 3. Port Forwarding and Access
    ...
    |
    v
## 📸 4. JSON Export in Grafana and add Data Source

    |  👀 
    |     kubectl apply -f grafana-datasource.yaml  # 🚀 Use it for the first time to set up 🛠️ 📌 mandatory

    |     kubectl create secret generic datasource-secret --from-file=datasource-secret.yaml 📌 mandatory
    +--> **Create a dashboard**
    +--> **Add 2 random walks**
    +--> **Save the dashboard**
    |
