...
## 📦 2. Grafana Installation
    ...
    +--> **Install via Helm**
    |     ```bash 
    |     helm repo add bitnami https://charts.bitnami.com/bitnami  # 🚀 Use it for the first time to set up 🛠️
    |     helm repo update  # 🚀 Use it for the first time to set up 🛠️
...
## 📸 5. Dashboard by Code
    ...
    | kubectl exec -it -n grafana-monitoring grafana-6b7b4d564b-492h7 -- ls /opt/bitnami/grafana/dashboards
